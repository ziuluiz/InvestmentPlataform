...
namespace InvestmentPlataform.Server.Migrations
{
    ...
    [Migration("20231101083535_order")]
    partial class order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestmentPlataform.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestmentPlataform.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("InvestmentPlataform.Shared.OrderItem", b =>
                {
                    b.HasOne("InvestmentPlataform.Shared.Order", "Order")
                        .WithMany("OrderItems")
